...
export const servicesConfig: Service[] = [
  {
    ...
    description:
      "We connect US enterprises and startups with pre-vetted, job-ready tech talent. From contract staffing to full-time placements — we source, screen, and deliver candidates aligned to your exact requirements across all work authorizations.",
    emoji: "🤝",
    icon: Handshake,
    badge: "New",
    ...
    caseStudy: { client: "Fortune 500 Tech Firm (Seattle, WA)", result: "42 engineers hired in 6 weeks, 94% retention at 1 year", time: "6 weeks" },
  ...
  },
  {
    ...
    description:
      "We build performant, SEO-friendly, accessible web applications using React, Next.js, and Node.js. From marketing sites to complex enterprise SaaS platforms serving US markets.",
    emoji: "🌐",
    icon: Globe,
    badge: "Popular",
    ...
    caseStudy: { client: "FinTech Startup (New York, NY)", result: "3× faster load time, 45% conversion lift", time: "3 months" },
    category: "Core",
  ...
  },
  {
    ...
    description:
      "We craft delightful mobile experiences for iOS and Android. Whether native performance or cost-effective cross-platform, we deliver app-store-ready products for US and global markets.",
    emoji: "📱",
    icon: Smartphone,
    badge: "",
    ...
    caseStudy: { client: "EdTech Platform (Austin, TX)", result: "100K+ downloads in 6 weeks", time: "4 months" },
    category: "Core",
  ...
  },
  {
    ...
    description:
      "We build AI-powered products — from recommendation engines to custom LLM applications. Our ML engineers bring research-level expertise to real US business problems.",
    emoji: "🤖",
    icon: Brain,
    badge: "Hot",
    ...
    caseStudy: { client: "Healthcare Provider (Chicago, IL)", result: "Medical report analysis in 3s vs 2 hrs", time: "5 months" },
    category: ["Core", "Advanced"],
  ...
  },
  {
    ...
    description:
      "We design user-centric interfaces that combine aesthetic appeal with functional clarity. From wireframes to high-fidelity prototypes and design systems for US tech companies.",
    emoji: "🎨",
    icon: Palette,
    badge: "",
    ...
    caseStudy: { client: "SaaS Startup (San Francisco, CA)", result: "52% drop in user drop-off after redesign", time: "6 weeks" },
    category: "Core",
  ...
  },
  {
    ...
    description:
      "We build complete SaaS platforms from idea to launch — including multi-tenancy, billing, onboarding, and analytics dashboards for US startups and enterprises.",
    emoji: "🚀",
    icon: PackageOpen,
    badge: "",
    ...
    tech: ["Next.js", "Stripe / Braintree", "Prisma / Supabase", "AWS / GCP", "Kubernetes", "Segment / Mixpanel"],
    deliverables: [
    ...
    caseStudy: { client: "HR Tech Startup (Boston, MA)", result: "Launched MVP in 10 weeks, 200 paying customers in Month 1", time: "10 weeks" },
    category: ["Core", "Advanced"],
  ...
  },
  {
    ...
    description:
      "End-to-end custom software development for US enterprises and startups — ERPs, CRMs, SaaS products, and legacy system modernization.",
    emoji: "💻",
    icon: Code2,
    badge: "",
    ...
    caseStudy: { client: "Logistics Company (Dallas, TX)", result: "30% ops cost reduction via automation", time: "8 months" },
    category: "Core",
